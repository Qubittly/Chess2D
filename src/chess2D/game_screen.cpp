...
GameWindow::GameWindow(int width, int height)
    : gameBoard(std::min(width, height)),
      deltaTime(0.0)  // Board is always square
{
...
void GameWindow::handleMouseClick(int mouseX, int mouseY, Board& board, bool leftMouseClicked) {
...
const int GameWindow::getSelectedPieceSquare() const { return selectedSquare; }

void GameWindow::clearSelection() { selectedSquare = -1; }
