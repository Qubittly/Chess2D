 ...
 *   }
 */
inline bool getBit(uint64_t bb, int square) { return (bb & (1ULL << square)) != 0; }
 ...
 */
inline void toggleBit(uint64_t& bb, int square) { bb ^= (1ULL << square); }
 ...
 *   }
 */
inline bool any(uint64_t bb) { return bb != 0; }
 ...
 *   }
 */
inline bool none(uint64_t bb) { return bb == 0; }
}  // namespace Chess
